...
- (void)getServiceIntroduce
{
    ...
    LTools *tool = [[LTools alloc]initWithUrl:CAR_SHOP_INTRODUCE isPost:NO postData:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *identify = @"ShopIntroduceCell";
    
    if (indexPath.row == 0) {
        
        ShopIntroduceCell *cell = (ShopIntroduceCell *)[LTools cellForIdentify:identify cellName:@"ShopIntroduceCell" forTable:tableView];
