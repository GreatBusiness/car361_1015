...
//        
        self.contnetWebView=[[UIWebView alloc]initWithFrame:CGRectMake(0, 0, ALL_FRAME_WIDTH, ALL_FRAME.size.height-64)];
...
//    self.timeLabel.text=the_myModel.time;
    ...
    [self.contnetWebView loadHTMLString:the_myModel.htmlsrngcontent baseURL:nil];
