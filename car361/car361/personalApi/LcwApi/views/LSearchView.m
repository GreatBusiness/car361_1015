        ...
        searchBlock:(SearchBlock)aBlock
{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"BBS-seach-kuang"]];
...
//        _searchField.placeholder = placeholder;
        ...
        [string addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithHexString:@"999a9c"] range:NSMakeRange(0, string.length)];
        _searchField.attributedPlaceholder = string;
